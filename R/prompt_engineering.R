...
pe_write_eng_sentence_based_idea <- function(knowledge=NULL) {
  ...
  knowledge %>%
    ...
    teach_gpt(me="evidence that continuing our current approach, unintended consequences and our knowledge products often fail to engage the IS artifact in novel ways. ",
